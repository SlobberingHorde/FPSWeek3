...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(x => !x.text.split(" ").toList.intersect(google).isEmpty)
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(x => !x.text.split(" ").toList.intersect(apple).isEmpty)

//  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(x => x.text.contains("Android"))
//  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(x => x.text.contains("iPhone"))
  /**
